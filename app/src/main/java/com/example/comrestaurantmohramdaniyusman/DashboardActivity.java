package com.example.comrestaurantmohramdaniyusman;
...
import com.example.comrestaurantmohramdaniyusman.adapter.RestaurantAdapter;
import com.example.comrestaurantmohramdaniyusman.data.Session;
import com.example.comrestaurantmohramdaniyusman.model.ListRestaurantResponse;

import static com.example.comrestaurantmohramdaniyusman.data.Constans.CREATE_RESTAURANT;
import static com.example.comrestaurantmohramdaniyusman.data.Constans.DELETE_RESTAURANT;
import static com.example.comrestaurantmohramdaniyusman.data.Constans.GET_LIST_RESTAURANT;
import static com.example.comrestaurantmohramdaniyusman.data.Constans.GET_SEARCH_RESTAURANT;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_create:
                AndroidNetworking.post(CREATE_RESTAURANT)
                        ...
                        .addBodyParameter("namarm","Ramen Ichiraku")
                        .addBodyParameter("kategori","kedai")
                        .addBodyParameter("link_foto","https://imgcdn1.kwikku.com/images_users/images_article_list/75187-listicle-20180527113610.jpg")
                        .addBodyParameter("alamat","Konoha ")
                        .build()
